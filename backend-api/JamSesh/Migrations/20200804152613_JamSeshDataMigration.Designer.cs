...
namespace JamSesh.Migrations
{
    ...
    [Migration("20200804152613_JamSeshDataMigration")]
    partial class JamSeshDataMigration
    {
            ...
            modelBuilder.Entity("JamSesh.Models.Jam", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EventDate = new DateTime(2020, 8, 4, 11, 26, 12, 510, DateTimeKind.Local).AddTicks(7097),
                            Image = "JamIcon.jpg",
